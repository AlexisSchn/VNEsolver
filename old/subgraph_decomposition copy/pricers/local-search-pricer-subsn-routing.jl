...
function solve_local_search_pricer_subsn_routing(v_subgraph, s_subgraph, sub_instance, original_instance, vn_decompo, dual_costs, additional_costs_routing; nb_iterations=500)
